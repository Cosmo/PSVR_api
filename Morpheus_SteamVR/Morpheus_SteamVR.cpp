// Morpheus_SteamVR.cpp : Defines the exported functions for the DLL application.
//

#include "stdafx.h"
#include "Morpheus_SteamVR.h"
...
static const char * const k_pch_Morpheus_Section = "driver_morpheus";
static const char * const k_pch_Morpheus_EnableSampleDriver_Bool = "enable";
static const char * const k_pch_Morpheus_SerialNumber_String = "serialNumber";
static const char * const k_pch_Morpheus_ModelNumber_String = "modelNumber";
static const char * const k_pch_Morpheus_WindowX_Int32 = "windowX";
static const char * const k_pch_Morpheus_WindowY_Int32 = "windowY";
static const char * const k_pch_Morpheus_WindowWidth_Int32 = "windowWidth";
static const char * const k_pch_Morpheus_WindowHeight_Int32 = "windowHeight";
static const char * const k_pch_Morpheus_RenderWidth_Int32 = "renderWidth";
static const char * const k_pch_Morpheus_RenderHeight_Int32 = "renderHeight";
static const char * const k_pch_Morpheus_SecondsFromVsyncToPhotons_Float = "secondsFromVsyncToPhotons";
static const char * const k_pch_Morpheus_DisplayFrequency_Float = "displayFrequency";
...
class CClientDriver_Sample g_clientDriver;
...
public:
		...
		, m_unObjectId(vr::k_unTrackedDeviceIndexInvalid)
	{
		...
		if (pSettings)
		{
			...
			char buf[1024];
			pSettings->GetString(k_pch_Morpheus_Section, k_pch_Morpheus_SerialNumber_String, buf, sizeof(buf));
			m_sSerialNumber = buf;

			pSettings->GetString(k_pch_Morpheus_Section, k_pch_Morpheus_ModelNumber_String, buf, sizeof(buf));
			m_sSerialNumber = buf;

			m_nWindowX = pSettings->GetInt32(k_pch_Morpheus_Section, k_pch_Morpheus_WindowX_Int32);
			m_nWindowY = pSettings->GetInt32(k_pch_Morpheus_Section, k_pch_Morpheus_WindowY_Int32);
			m_nWindowWidth = pSettings->GetInt32(k_pch_Morpheus_Section, k_pch_Morpheus_WindowWidth_Int32);
			m_nWindowHeight = pSettings->GetInt32(k_pch_Morpheus_Section, k_pch_Morpheus_WindowHeight_Int32);
			m_nRenderWidth = pSettings->GetInt32(k_pch_Morpheus_Section, k_pch_Morpheus_RenderWidth_Int32);
			m_nRenderHeight = pSettings->GetInt32(k_pch_Morpheus_Section, k_pch_Morpheus_RenderHeight_Int32);
			m_flSecondsFromVsyncToPhotons = pSettings->GetFloat(k_pch_Morpheus_Section, k_pch_Morpheus_SecondsFromVsyncToPhotons_Float);
			m_flDisplayFrequency = pSettings->GetFloat(k_pch_Morpheus_Section, k_pch_Morpheus_DisplayFrequency_Float);
		}
		else
		{
		...
		DriverLog("driver_morpheus: Serial Number: %s\n", m_sSerialNumber.c_str());
		DriverLog("driver_morpheus: Model Number: %s\n", m_sModelNumber.c_str());
		DriverLog("driver_morpheus: Window: %d %d %d %d\n", m_nWindowX, m_nWindowY, m_nWindowWidth, m_nWindowHeight);
		DriverLog("driver_morpheus: Render Target: %d %d\n", m_nRenderWidth, m_nRenderHeight);
		DriverLog("driver_morpheus: Seconds from Vsync to Photons: %f\n", m_flSecondsFromVsyncToPhotons);
		DriverLog("driver_morpheus: Display Frequency: %f\n", m_flDisplayFrequency);
		DriverLog("driver_morpheus: IPD: %f\n", m_flIPD);
	}
...
class CServerDriver_Sample g_serverDriver;
...
MORPHEUS_STEAMVR_API void* HmdDriverFactory(const char* pInterfaceName, int* pReturnCode)
{
